          ...
          <form onSubmit={handleSubmit} className="space-y-4 text-left">
            ...
            {awBookId && !isRevisionMode && (
              <label className="flex items-center gap-2 text-xs font-bold text-gray-600 cursor-pointer select-none py-1">
                <input
                  type="checkbox"
                  checked={isAwForceRevision}
                  onChange={(e) => setIsAwForceRevision(e.target.checked)}
                  className="w-4 h-4 rounded text-brand-primary focus:ring-brand-primary cursor-pointer font-bold"
                />
            ...
            {awBookId && (
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-white border border-gray-250 rounded-xl px-3 py-2 text-xs font-semibold outline-none focus:ring-2 focus:ring-brand-soft h-16 resize-none font-bold text-gray-750"
                />
              </div>
            )}
...
export default SyllabusAddWorkModal;
